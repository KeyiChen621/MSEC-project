...
%% Plot mean ± 95% CI for all groups
for i = 1:5
    data = data_all{i};                    % Current dataset (22 × 8)
    mu   = mean(data, 2);                  % Mean 1/f slope across subjects
...
ylabel('1/f Slopes', 'FontSize', baseFontSize, 'FontWeight', 'bold');
xlim([1 22]);
xticks(1:2:22);   % Optional: display every other day
