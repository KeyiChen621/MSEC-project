%% 3D Line Plot with Spheres and Custom Blue Gradient Visualization
figure;
hold on;

% Define a custom blue gradient colormap (4 colors)
baseColors = [
    208, 240, 255;
    139, 209, 255;
     46, 145, 229;
...
% Calculate the number of lines to plot (each pair of rows forms a line)
...
for i = 1:2:size(points,1)
    % Extract 5 points' X/Y/Z coordinates
